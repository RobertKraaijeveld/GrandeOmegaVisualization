#ifndef NightOnlyCompletionsVsGradeClassification_H
#define NightOnlyCompletionsVsGradeClassification_H
...
class NightOnlyCompletionsVsGradeClassification : public IClassificationVisualization
{
private:
...
public:
  NightOnlyCompletionsVsGradeClassification(std::shared_ptr<IClassifier> cl,
